            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.optionsContainer}>
                    <ServiceOption
                        ...
                        icon="add-circle"
                        color="#EF4444"
                        onPress={() => navigateToForm('New Gas Connection')}
                    />
                    <ServiceOption
                        title="Transfer Connection"
                        icon="swap-horizontal"
                        color="#EF4444"
                        onPress={() => navigateToForm('Transfer Connection')}
                    />
                    <ServiceOption
                        title="Name Correction"
                        icon="text"
                        color="#EF4444"
                        onPress={() => navigateToForm('Name Correction')}
                    />
                </View>
                ...
                <View style={styles.emptyState}>
                    ...
                    <TouchableOpacity style={styles.applyButton} onPress={() => navigateToForm('New Gas Application')}>
